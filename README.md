...
Minat Utama - Geological Engineering

## Pendidikan
Teknik Geologi - Institut Teknologi Nasional Yogyakarta

## Keahlian 
**Geology and GIS : ArcGIS, QGIS, Global Mapper, Corel Draw
**Programing and data : Phyton (Basic), Microsoft Word, Microsoft Excel
**Bahasa : Indonesia (Native), English (Profesional)

## Proyek
**Studi Dan karakteristik Lava Nglanggram Gunung api nglanggran** Studi kasus dan 
